...
GInt = Extension('_GaussInt_ThWave', # name of the extension
                    sources=['SwigGaussInt.i', 'ThermalWave_Interface.cpp'], # a list of source filenames. May be C,C++,Objective-C,SWIG
                    swig_opts=["-c++"],
                    extra_compile_args=["-fopenmp"],
                    extra_link_args=["-fopenmp"],
                  )

setup (name = 'GaussInt_ThWave',
       ext_modules = [GInt],
       author      = 'Tony Alberti',
